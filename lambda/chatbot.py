...
from utils import send_typing_action, generate_transcription
...
telegram_token = boto3.client(service_name='ssm').get_parameter(Name="TELEGRAM_TOKEN")["Parameter"]["Value"]
